...
import { music_type_defs } from "./@music/music.type-def";
...
const type_defs = [main_types, test_type_def, user_type_def, book_type_def, journal_type_defs, screen_time_type_defs, series_type_defs, movie_type_defs, poem_type_defs, target_type_defs, music_type_defs];
